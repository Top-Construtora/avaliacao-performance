    ...
    return (
      <div className="space-y-6">
        <motion.div
          ...
          className="bg-white dark:bg-yt-surface rounded-2xl shadow-sm border border-gray-200 dark:border-yt-border p-8 text-center"
        >
                ...
                <button
                  ...
                  className={`px-8 py-3 rounded-xl border-2 text-sm font-medium transition-all ${
                    answers[question.id]?.boolean_value === true
                      ? 'border-green-500 bg-green-50 dark:bg-primary-900/20 text-green-700 dark:text-green-300'
