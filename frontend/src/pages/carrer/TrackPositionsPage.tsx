      ...
      <div className="min-h-screen bg-gray-50 dark:bg-yt-bg p-4">
        <div className="max-w-7xl mx-auto space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="px-2 py-1 text-xs bg-green-100 text-green-800 dark:bg-primary-900/30 dark:text-green-400 rounded-full">
                                {salaryClass?.name}
                              </span>
                              {!trackPos.active && (
          ...
          <motion.div
            ...
            className="bg-green-50 dark:bg-primary-900/20 rounded-xl p-4"
          >
              ...
              >
                ...
                <div className="space-y-4">
                  {!showNewPositionForm ? (
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="flex-1 grid grid-cols-2 gap-2">
                                    ...
                                    {/* Salário */}
                                    <div className="px-2 py-1.5 bg-green-50 dark:bg-primary-900/20 border border-green-200 dark:border-green-800 rounded text-sm font-semibold text-green-700 dark:text-green-400">
                    ...
                    <>
                      <div className="bg-green-50 dark:bg-primary-900/20 rounded-lg p-3 mb-4">
                        <div className="flex items-center justify-between">
                    ...
                    {levelSalaries.map((levelSalary, index) => (
                      <div
                        ...
                        className={`
                          ...
                          ${index === 0 
                            ? 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-primary-900/20' 
