                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2">
                            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs ${
                              track.active 
                                ? 'bg-green-100 text-green-800 dark:bg-primary-900/30 dark:text-green-400' 
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-yt-border rounded-lg dark:bg-yt-elevated dark:text-gray-100 focus:ring-2 focus:ring-green-800 focus:border-transparent"
            >
