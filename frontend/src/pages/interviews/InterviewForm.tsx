...
const RatingInput = ({
  ...
  <div className="space-y-3 p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-600">
      ...
      {isEditing && type === 'ninety_days' && (
        ...
        >
          ...
          <div className="space-y-4">
            ...
            {/* Expectativas */}
            <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-600">
