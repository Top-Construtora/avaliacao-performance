          ...
          <div className="space-y-4">
            ...
            <AnimatePresence>
              {showFilters && (
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6 bg-gradient-to-br from-gray-50 to-gray-100/50 dark:from-yt-elevated/30 dark:to-yt-elevated/50 rounded-xl border border-gray-200 dark:border-yt-border">
                    <div>
