...
const Consensus = () => {
  ...
  const categoryConfig = {
    ...
    'Comportamental': {
      ...
      gradient: 'from-gray-500 to-gray-600 dark:from-gray-600 dark:to-yt-elevated'
    },
    'Organizacional': {
  ...
  const ScoreButton = ({ score, isSelected, onClick, disabled }: {
    ...
    <button
      ...
      className={`w-12 h-12 rounded-xl flex items-center justify-center text-sm font-bold transition-all duration-200 ${
        ...
        isSelected
          ? 'bg-gradient-to-br from-gray-600 to-gray-700 dark:from-gray-600 dark:to-yt-elevated text-white shadow-lg ring-2 ring-gray-400 dark:ring-gray-500 ring-offset-2 dark:ring-offset-gray-800'
  ...
  const ScoreIndicator = ({
    ...
    const bg = 'bg-gradient-to-br from-gray-600 to-gray-700 dark:from-gray-600 dark:to-yt-elevated';
            ...
            {Object.keys(consensusScores).length > 0 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-gray-600 to-gray-700 dark:from-gray-600 dark:to-yt-elevated p-4 sm:p-6 rounded-xl text-white">
