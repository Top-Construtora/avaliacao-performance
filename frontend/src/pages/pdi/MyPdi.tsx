...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  '4': { label: 'Concluído', color: 'bg-green-100 text-green-700 dark:bg-primary-900/30 dark:text-green-300' },
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        {renderPdiSection(
          ...
          'bg-gradient-to-br from-gray-500 to-gray-600 dark:from-gray-600 dark:to-yt-elevated'
        )}
