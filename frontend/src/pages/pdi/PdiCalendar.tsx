...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: any }> = {
  ...
  '4': { label: 'Concluído', color: 'bg-green-100 dark:bg-primary-900/30 text-green-700 dark:text-green-300 border-green-200 dark:border-green-700', icon: CheckCircle },
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="lg:col-span-2 bg-white dark:bg-yt-surface rounded-2xl shadow-sm border border-gray-200 dark:border-yt-border p-6"
        >
          {/* Navegação do mês */}
                  ...
                  className={`relative min-h-[60px] sm:min-h-[72px] p-1 rounded-lg border transition-all text-left ${
                    isSelected
                      ...
                      : isToday
                        ...
                        : isCurrentMonth
                          ? 'border-gray-100 dark:border-yt-border hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700/50'
        ...
        <motion.div
          ...
          className="bg-white dark:bg-yt-surface rounded-2xl shadow-sm border border-gray-200 dark:border-yt-border p-6"
        >
