  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <motion.div
        ...
        style={{ background: 'linear-gradient(135deg, #001915 0%, #003b2b 100%)' }}
      >
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-gray-100 mb-2 tracking-wide">
                  {action.title}
                </h3>
                ...
                <div className="inline-flex items-center text-sm font-semibold group-hover:gap-2 sm:group-hover:gap-3 transition-all duration-300" style={{ color: '#003b2b' }}>
                  <span className="dark:text-[#003b2b]">{action.action}</span>
              ...
              <div
                ...
                style={{
                  padding: '2px',
                  background: 'linear-gradient(135deg, #001915 0%, #003b2b 100%)',
