          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-8 space-y-6 border border-gray-200">
            <div className="text-center space-y-4">
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-lg font-medium text-white transition-all duration-200 flex items-center justify-center gap-2 hover:-translate-y-0.5 hover:shadow-md hover:opacity-90 active:scale-[0.98] bg-gradient-to-r from-primary-900 to-primary-700"
              >
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-8 space-y-6 border border-gray-200">
          ...
          <div className="text-center space-y-2">
            <motion.div
              ...
              animate={{ scale: 1 }}
              transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
              className="inline-flex items-center justify-center w-16 h-16 rounded-xl shadow-lg bg-gradient-to-br from-primary-700 to-primary-900"
            >
            ...
            <button
              ...
              className={`w-full py-3 px-6 rounded-lg font-medium text-white transition-all duration-200 flex items-center justify-center gap-2 hover:-translate-y-0.5 hover:shadow-md ${
                loading
                  ...
                  : 'bg-gradient-to-r from-primary-900 to-primary-700 hover:opacity-90 active:scale-[0.98]'
              }`}
            >
              {loading ? (
                <>
