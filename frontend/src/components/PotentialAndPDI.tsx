...
const PotentialAndPDI: React.FC<PotentialAndPDIProps> = ({
  ...
  const potentialRatingLabels: Record<number, { label: string; color: string; darkColor: string }> = {
    ...
    3: { label: 'Atende ao esperado', color: 'bg-green-800', darkColor: 'dark:bg-primary-900' },
  ...
  const statusOptions = [
    ...
    { value: '2', label: 'Iniciado', color: 'bg-green-100 dark:bg-primary-900/30 text-green-900 dark:text-green-300 border-green-300 dark:border-green-700' },
    ...
    { value: '5', label: 'Concluído', color: 'bg-green-100 dark:bg-primary-900/30 text-green-700 dark:text-green-300 border-green-300 dark:border-green-700' }
  ];
  ...
  const categories = [
    ...
    },
    {
      ...
      iconBg: 'bg-gradient-to-br from-gray-500 to-gray-600 dark:from-gray-600 dark:to-yt-elevated',
                      ...
                      >
                        ...
                        <div className="space-y-4 sm:space-y-6">
                          ...
                          <div>
                            ...
                            <textarea
                              className="w-full rounded-lg border-gray-200 dark:border-yt-border bg-white dark:bg-yt-elevated shadow-sm focus:border-green-800 dark:focus:border-primary-400 focus:ring-green-800 dark:focus:ring-primary-400 text-gray-700 dark:text-gray-300 transition-all duration-200 text-sm sm:text-base"
                          ...
                          <div>
                            ...
                            <input
                              type="month"
                              className="w-full rounded-lg border-gray-200 dark:border-yt-border bg-white dark:bg-yt-elevated shadow-sm focus:border-gray-500 dark:focus:border-gray-400 focus:ring-gray-500 dark:focus:ring-gray-400 text-gray-700 dark:text-gray-300 transition-all duration-200 text-sm sm:text-base"
                          ...
                          <div>
                            ...
                            <textarea
                              className="w-full rounded-lg border-gray-200 dark:border-yt-border bg-white dark:bg-yt-elevated shadow-sm focus:border-stone-600 dark:focus:border-stone-500 focus:ring-stone-600 dark:focus:ring-stone-500 text-gray-700 dark:text-gray-300 transition-all duration-200 text-sm sm:text-base"
                              rows={3}
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-yt-border">
                            ...
                            <div>
                              ...
                              <select
                                className="w-full rounded-lg border-gray-200 dark:border-yt-border bg-white dark:bg-yt-elevated shadow-sm focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500 dark:focus:ring-green-400 text-gray-700 dark:text-gray-300 transition-all duration-200 text-sm sm:text-base"
                                value={item.status}
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <textarea
                            ...
                            placeholder="Ex: Liderança, Comunicação, Gestão de Projetos..."
                            rows={3}
                            className="w-full px-4 py-2 bg-gray-100 dark:bg-yt-bg border border-gray-300 dark:border-yt-border rounded-lg focus:ring-green-800 focus:border-green-800 text-gray-900 dark:text-gray-100"
                          />
                        </div>
      ...
      {currentStep === 2 && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-stone-50 to-green-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-800 rounded-xl sm:rounded-2xl shadow-sm dark:shadow-lg border border-stone-100 dark:border-yt-border p-4 sm:p-6 lg:p-8"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-white dark:bg-yt-surface p-4 sm:p-6 rounded-lg sm:rounded-xl border border-stone-200 dark:border-stone-700">
              ...
              <div className="bg-white dark:bg-yt-surface p-4 sm:p-6 rounded-lg sm:rounded-xl border border-green-200 dark:border-green-700">
