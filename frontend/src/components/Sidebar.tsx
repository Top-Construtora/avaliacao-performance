          ...
          {isCollapsed && !isMobile ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center p-3 rounded-lg text-white/90 hover:bg-white/10 hover:text-white transition-all duration-200"
                title="Sair"
              >
  ...
  return (
    <>
      ...
      {collapsedDropdown && isCollapsed && createPortal(
        <AnimatePresence>
          <motion.div
            ...
            className="bg-[#001915] rounded-lg shadow-lg py-2 min-w-[200px]"
      ...
      <motion.aside
        ...
        style={{ background: 'linear-gradient(180deg, #001915 0%, #002a20 100%)' }}
      >
