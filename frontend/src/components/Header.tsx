    ...
    <header className="bg-primary-900 dark:bg-primary-900 border-b border-white/10 sticky top-0 z-20">
      <div className="flex items-center justify-between h-[77px] px-3 sm:px-4 md:px-6">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          <h1 className="text-base sm:text-lg md:text-xl font-semibold text-white truncate tracking-wider">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 flex-shrink-0">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            >
              ...
              <div className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 rounded-full bg-primary-700 flex items-center justify-center text-white font-semibold text-xs sm:text-sm flex-shrink-0 shadow-md">
